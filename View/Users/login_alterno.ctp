...
<div class="explanation">
	...
	El registro para los grupos es por la entrada de la Rotonda del Jardín Botánico, cerca de la estación del Metro Universidad. 
	</br>
	Allí puedes ingresar con tu grupo y disfrutar de todas las actividades de la Fiesta del Libro y la Cultura.
	</br></br>
...
<!-- 	<div class="login">
		...
		<!-- <span><?php //echo '¿Aún no tienes una cuenta?' ?></span>
		<?php //secho $this->Html->link(__('Regístrate.'), array('controller' => 'institutions', 'action' => 'findinstitution')); ?>
		</n> -->
