...
<?php $this->set('title_for_layout' , 'Ver sesión de carpa' );?>
	...
	<tr>
		...
		<td><?php echo $this->Html->link($workshopSession['Workshop']['name'], array('controller' => 'Workshops', 'action' => 'view', $workshopSession['Workshop']['id_workshop'])); ?></td>
		<td class="actions">
