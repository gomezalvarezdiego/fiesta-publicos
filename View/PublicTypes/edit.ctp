...
<div class="actions">
	...
	<ul>
		...
		<li><?php //echo $this->Form->postLink(__('Delete Public Types'), array('action' => 'delete', $this->Form->value('PublicType.id_public_type')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PublicType.id_public_type'))); ?></li>
