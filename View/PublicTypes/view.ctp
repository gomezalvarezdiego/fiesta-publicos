...
<h2><?php echo __('Tipo de público'); ?></h2>
	<dl>		<dt><?php echo __('Nombre:'); ?></dt>
		<dd>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Public Type'), array('action' => 'delete', $publicType['PublicType']['id_public_type']), null, __('Está seguro que desea Eliminar # %s?', $publicType['PublicType']['id_public_type'])); ?> </li>
