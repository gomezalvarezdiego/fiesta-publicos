 ...
 */
	var $defaultOptions = array(
		...
		'dir' => 'file{DS}uploads{DS}{ModelName}',
		...
		'allowedMime' => array('image/jpeg', 'image/pjpeg', 'image/png', 'image/gif', 'image/bmp', 'image/x-icon', 'image/vnd.microsoft.icon','application/msword',
				...
				'application/vnd.openxmlformats-officedocument.spreadsheetml.template','application/vnd.ms-excel.template.macroEnabled.12','application/vnd.ms-excel.sheet.binary.macroEnabled.12','text/csv',
 ...
 */
	function __construct() {
		$messages = array(
			...
			'Empty' => array(
				'message' => __d('meio_upload', 'Seleccione archivo.')
			),
			'UploadError' => array(
				'message' => __d('meio_upload', 'No se pudo subir archivo.')
			),
			'MaxSize' => array(
